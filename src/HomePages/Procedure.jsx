  ...
  const steps = [
    {
      ...
      description:
        "Navigate to our user-friendly platform and explore the investment opportunities available to you.",
      icon: "🌐",
    },
    {
      step: 2,
      ...
      description:
        "Fill out the simple registration form with your basic details and verify your identity securely.",
      icon: "📝",
    },
    {
      step: 3,
      ...
      description:
        "Upload required documents for quick verification and compliance with regulatory standards.",
      icon: "✅",
    },
    {
      step: 4,
      title: "Start Trading",
      description:
        "Fund your account and begin your investment journey with our comprehensive trading tools.",
      icon: "🚀",
    },
  ];
